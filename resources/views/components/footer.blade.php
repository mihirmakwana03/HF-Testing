            ...
            <div class="col-lg col-md-6 col-sm-12 mb-4 text-md-left">
                ...
                <div class="d-flex flex-column align-items-md-start">
                    <a href="https://apps.apple.com/us/app/happiness-factors/id1575587044" target="_blank" class="mb-3" style="overflow: hidden;">
                        <lottie-player src="{{ asset('assets/json/App-Store.json') }}" background="transparent" speed="0.5" style="width: 170px; height: 170px; margin: -60px -10px;" loop autoplay></lottie-player>
                    </a>
                    <a href="#" target="_blank" style="overflow: hidden;">
                        <lottie-player src="{{ asset('assets/json/Google-Play.json') }}" background="transparent" speed="0.5" style="width: 170px; height: 170px; margin: -60px -10px;" loop autoplay></lottie-player>
                    </a>
                </div>
            </div> -->
