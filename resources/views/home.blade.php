        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="position-relative">
                    ...
                    <!-- <lottie-player src="{{ asset('assets/json/Free-Growth-Cover-Animation.json') }}" background="transparent" speed="0.5" style="width: 100%; max-width: 500px; height: auto;" loop autoplay></lottie-player> -->
                ...
                <div class="timeline-modern position-relative mx-auto" style="max-width:900px;">
                    ...
                    <div class="timeline-modern-item left">
                        ...
                        <div class="timeline-modern-content shadow bg-white rounded-lg">
                            ...
                            <h3 class="mb-1"><img src="{{ asset('assets/img/GIF/smiling_face_with_heart_eyes.gif') }}" alt="Connect With HappinessFactors" style="height: 55px; width: 55px;"> Connect With HappinessFactors</h3>
                    ...
                    <div class="timeline-modern-item right">
                        ...
                        <div class="timeline-modern-content shadow bg-white rounded-lg">
                            ...
                            <h3 class="mb-1"><img src="{{ asset('assets/img/GIF/magnifying-glass.gif') }}" alt="Inner Compass Activated" style="height: 55px; width: 55px;"> Inner Compass Activated</h3>
                    ...
                    <div class="timeline-modern-item left">
                        ...
                        <div class="timeline-modern-content shadow bg-white rounded-lg">
                            ...
                            <h3 class="mb-1">
                                 ...
                                 <dotlottie-player
                                         src="{{ asset('assets/json/brain.json') }}"
                    ...
                    <div class="timeline-modern-item right">
                        ...
                        <div class="timeline-modern-content shadow bg-white rounded-lg">
                            ...
                            <h3 class="mb-1"><img src="{{ asset('assets/img/GIF/direct_hit.gif') }}" alt="Relaxation/Flow Zone!" style="height: 55px; width: 55px;"> Relaxation/Flow Zone!
                    ...
                    <div class="timeline-modern-item left">
                        ...
                        <div class="timeline-modern-content shadow bg-white rounded-lg">
                            ...
                            <h3 class="mb-1"><img src="{{ asset('assets/img/GIF/trophy.gif') }}" alt="The Glow-Up" style="height: 55px; width: 55px;"> The Glow-Up</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted mb-0"><img src="{{ asset('assets/img/GIF/heart-letter.gif') }}" alt="Got questions, big dreams, or just want to say hi?" style="height: 20px; width: 20px;"> Got questions, big dreams, or just want to say hi? <br>
                            ...
                            <span class="d-block mt-2">
                                <img src="{{ asset('assets/img/GIF/sparkle.gif') }}" alt="Sparkle" style="height: 20px; width: 20px;">
                                Let's turn your "meh" days into magic.
                                <img src="{{ asset('assets/img/GIF/purple-heart.gif') }}" alt="Purple heart" style="height: 20px; width: 20px;">
                            </span>
                        </p>
                    </div>
                    <div class="row mb-4">
